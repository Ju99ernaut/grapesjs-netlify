    ...
    renderSiteList() {
        ...
        let matchingSites = sortedSites.filter(site => {
            ...
            .map((site, i) => {
                ...
                return `<div class="site-wrapper" key="${i}" data-id="${site.id}" title="Select to deploy site here">
    ...
    render() {
        ...
        if (user && !user.token) {
            const login = $(`<div class="app">
                    <div id="login">
                        <button title="login with netlify" >
